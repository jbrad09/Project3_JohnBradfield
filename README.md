...
- [ Y] Pick an app screenshot to duplicate
  - Be sure to add the screenshot to "Chosen Screenshot" below.
- [ Y] Create a runnable app that displays an Animal Version of your chosen screenshot
- [ Y] Layout uses one (1) or more ConstraintLayout
- [ Y] Layout uses one (1) or more ImageView
- [ Y] Layout uses three (3) or more TextViews
